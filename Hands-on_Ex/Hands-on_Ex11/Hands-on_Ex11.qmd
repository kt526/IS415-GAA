...
The value has to be lesser than the minimum value to get the intra-zonal distances
:::
...
We are going to perform log transformation for poisson distribution. Log 0 will give us infinite. This is why we are replacing destinations with 0 into 0.99 (or any random number that is \< 1)
:::
...
glm denotes generalized linear model
