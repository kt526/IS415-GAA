...
The message above reveals that the geospatial objects are polygon features. There are a total of 88 polygron features and 7 fields in `hunan_sf`. `hunan_sf` is in **WGS 84** geographic coordinates systems. The bounding box provides the x extend and y extend of the data.

> The `hunan_sf` is in **WGS 84** geographic coordinates systems. We need to perform **projection transformation**!
