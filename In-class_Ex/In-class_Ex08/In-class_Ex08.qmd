...
In this In-class exercise, you will gain hands-on experience on how to **Calibrating Hedonic Pricing Model for Private Highrise Property with GWR Method**.
...
-   condo_resale_2015 in csv format (i.e. *condo_resale_2015.csv*)
    ...
    -   PROX_CBD are derived values (flying distance between condominium and CBD centroid)

    -   Decimal degree –\> data is likely in WGS84
...
2.  Calibrate the bandwidth into the GWR model
