...
|                                                   |                                                          |                                          | -   plotOutput()            |
+---------------------------------------------------+----------------------------------------------------------+------------------------------------------+-----------------------------+
| Nearest Neighbour Analysis using Clark-Evans Test | -   **nsim**: 99 to 999                                  | Statistics results                       | Parameters / Inputs         |
|                                                   |                                                          |                                          |                             |
|                                                   |                                                          |                                          | -   sliderInput()           |
|                                                   |                                                          |                                          |                             |
|                                                   |                                                          |                                          | Outputs                     |
...
+---------------------------------------------------+----------------------------------------------------------+------------------------------------------+-----------------------------+
| Complete Spatial Randomness (CSR) Test            | -   **nsim**: 99 to 999                                  | Plot interactive chart given inputs      | Parameters / Inputs         |
|                                                   |                                                          |                                          |                             |
