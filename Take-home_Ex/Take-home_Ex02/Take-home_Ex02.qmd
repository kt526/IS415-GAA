...
#### 5.1.2.1 Computing Contiguity Spatial Weights

```{r}

```

#### 5.1.2.2 Computing Global Moran's I

```{r}

```

#### 5.1.2.3 Performing Global Moran's I Test

```{r}

```

#### 5.1.2.4 Performing Global Moran's I Permutation Test with Monte-Carlo Simulation

```{r}

```

#### 5.1.2.5 Visualising Global Monte-Carlo Moran's I
