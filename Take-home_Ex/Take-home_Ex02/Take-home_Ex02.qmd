...
```{r}
pacman::p_load(plotly, tidyverse, tmap, sf, sp, sfdep)
```
...
![Figure 1. Image](imgs/dengue_extracted_view.png){fig-align="center"}
...
```{r}
tainan_counties_with_dengue <- tainan_towns_sf %>% 
  mutate(TOWNNAME_VILLNAME = paste(TOWNNAME, VILLNAME, sep="_")) %>%
...
tainan_dengue_cases_by_village_map <- tm_shape(tainan_dengue_cases_by_village) +
  ...
  tm_layout(main.title = "Distribution of Dengue Cases in Tainan Counties",
