...
|                                                                                      |                                                                                              |
| ![](imgs/positive_spatial_autocorrelation.png){fig-align="center" width="214"}       | ![](imgs/negative_spatial_autocorrelation.png){fig-align="center" width="221"}               |
+======================================================================================+==============================================================================================+
| -   Clustering (Like values tend to be in similar locations)                         | -   Checkerboard patterns (“opposite” of clustering)                                         |
|                                                                                      |                                                                                              |
| -   Neighbours are similar (more alike neighbours would be under spatial randomness) | -   Neighbours are dissimilar (more neighbours dissimilar would be under spatial randomness) |
|                                                                                      |                                                                                              |
| -   Compatible with diffusion (but not necessary caused by diffusion)                | -   Compatible to competition (but not necessary competition)                                |
+--------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------+
...
#### 5.2.1.2 Global measures of spatial autocorrelation

**5.2.1.2.1 Compute Spatial Weights**
...
**5.2.1.2.2 Compute Global Moran's I**
...
**5.2.1.2.3 Perform Global Moran's I Test**
...
**5.2.1.2.4 Perform Global Moran's I Permutation Test with Monte-Carlo Simulation**
...
**5.2.1.2.5 Visualising Global Monte-Carlo Moran's I**
...
## 5.3 Emerging HotSpot Analysis (EHSA)
